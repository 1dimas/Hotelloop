                ...
                <li className="flex gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600">
                      Our vision is to be the leading hotel in the region, known
                      for our exceptional service and luxurious accommodations.
                    </p>
                  </div>
                </li>
                <li className="flex gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600">
                      ...
                      experience for our guests, ensuring their comfort and
